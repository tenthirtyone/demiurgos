...
const Step2 = ({ match, history }) => {
  ...
  return (
    <Fragment>
      {back && <Redirect to={`/dashboard/procurement/Step1`} />}
      {forward && <Redirect to={`/dashboard/procurement/Step3`} />}
      <Panel className="panel-wallet">
        <Card className="">
          <Card className="card-inner">
            <h1 className="heading-1">Issue Work Order</h1>
